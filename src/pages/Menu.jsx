...
const Menu = () => {
  ...
  const menuItems = {
    ...
    'Cold Mezze': {
      items: [
        { name: 'CLASSIC HUMMUS', type: 'veg' },
        { name: 'BEETROOT HUMMUS', type: 'veg' },
        { name: 'SPICY PAPRIKA HUMMUS', type: 'veg' },
        { name: 'BEIRUTI HUMMUS',  type: 'veg' },
        { name: 'SPICY CHICKEN HUMMUS', type: 'non-veg' },
        { name: 'SPICY LAMB HUMMUS',  type: 'non-veg' },
        { name: 'TARIO HUMMUS', type: 'veg' },
        { name: 'LABNAH SPECIAL', type: 'veg' },
